<x-admin-layout>
    <div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
        <div class="bg-white shadow-md rounded-lg p-6">
            <h2 class="text-2xl font-semibold text-gray-800 mb-6">Formulario de Paralelos</h2>

            <form action="{{ route('administracion.administrativa.paralelos.store') }}" method="POST">
                @csrf
