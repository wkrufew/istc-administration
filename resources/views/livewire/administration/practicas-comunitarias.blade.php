<div>
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6"
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                <h2 class="text-2xl font-bold text-gray-800 dark:text-gray-100">Prácticas Comunitarias</h2>
                <p class="text-gray-500 dark:text-gray-400 text-sm mt-1">Gestión de prácticas comunitarias de estudiantes con malla completa</p>
            </div>
        ...
        <div class="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6">
            ...
            <div class="relative w-full max-w-2xl flex flex-col max-h-[90vh]
                ...
                <div class="flex-1 overflow-y-auto p-6 space-y-5">
                    ...
                    <div>
                        <label class="block text-xs font-semibold text-gray-600 dark:text-slate-300 mb-1">
                            Programa de Vinculación <span class="text-red-500">*</span>
                        </label>
                        <input type="text" wire:model="programa_vinculacion"
                            class="w-full rounded-xl border border-gray-200 dark:border-slate-600
                                   ...
                                   placeholder-gray-400 dark:placeholder-slate-500
                                   shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm py-2.5 px-3"
                            placeholder="Nombre del programa de vinculación">
                    ...
                    <div class="border-t border-gray-100 dark:border-slate-700/60 pt-5">
                        <p class="text-xs font-bold text-gray-500 dark:text-slate-400 uppercase tracking-wide mb-3">Datos de la práctica comunitaria</p>
                        <div class="grid grid-cols-2 gap-4">
                            <div class="col-span-2">
                                <label class="block text-xs font-semibold text-gray-600 dark:text-slate-300 mb-1">
