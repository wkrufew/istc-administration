        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            ...
            <div class="lg:col-span-2">
                ...
                <input type="text" name="name" id="name" value="{{ old('name', $materia->name ?? '') }}"
                    required
                    class="w-full rounded-xl border border-gray-300 bg-gray-50 px-4 py-2.5 text-sm shadow-sm
                           focus:border-verdeclaro focus:ring-2 focus:ring-verdeclaro/40 transition">
            </div>
            ...
            {{-- Créditos --}}
            <div>
                <label for="credits" class="block text-sm font-semibold text-gray-700 mb-1">
                    Créditos
                </label>
            ...
            {{-- Cupo --}}
            <div>
                <label for="cupo_maximo" class="block text-sm font-semibold text-gray-700 mb-1">
                    Cupo Máximo
                </label>
            ...
            {{-- Nota mínima --}}
            <div>
                <label for="nota_minima_aprobacion" class="block text-sm font-semibold text-gray-700 mb-1">
            ...
            {{-- Semestre --}}
            <div>
                <label for="semestre_id" class="block text-sm font-semibold text-gray-700 mb-1">
                    Semestre
                </label>
            ...
            {{-- Horas teóricas --}}
            <div>
                <label for="horas_teoricas" class="block text-sm font-semibold text-gray-700 mb-1">
                    Horas Teóricas
                </label>
            ...
            {{-- Horas prácticas --}}
            <div>
                <label for="horas_practicas" class="block text-sm font-semibold text-gray-700 mb-1">
                    Horas Prácticas
                </label>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-5 mt-6">
            ...
            <div class="lg:col-span-2">
                ...
                <textarea name="description" id="description" rows="4"
                    class="w-full rounded-xl border border-gray-300 bg-gray-50 px-4 py-3 text-sm shadow-sm
                           focus:border-verdeclaro focus:ring-2 focus:ring-verdeclaro/40 transition">{{ old('description', $materia->description ?? '') }}</textarea>
            </div>
            ...
            <div class="flex items-start gap-3 rounded-xl border border-gray-200 bg-gray-50 p-4">
                ...
                <div>
                    <label for="is_active" class="font-semibold text-gray-800">
                        ¿Materia activa?
                    </label>
