            ...
            foreach ($data as $index => $row) {
                ...
                try {
                    ...
                    $user = User::create([
                        ...
                        'is_facturador'            => !empty($row[20]) && strtolower((string) $row[20]) === 'si',
                        'fact_nombre'              => $row[21] ?? null,
                        'fact_documento'           => $row[22] ?? null,
                        'fact_correo'              => $row[23] ?? null,
                        'fact_direccion'           => $row[24] ?? null,
                        'fact_telefono'            => $row[25] ?? null,
                        'is_active'                => true,
                    ]);
