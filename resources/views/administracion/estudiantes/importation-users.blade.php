<x-admin-layout>
    <div class="p-4 rounded-lg bg-gray-100 dark:bg-gray-800 shadow-md">
        ...
        <div class="flex items-center justify-between">
            <h1 class="text-2xl font-bold text-gray-800 dark:text-gray-200">Importacion de Estudiantes</h1>
            <a href="{{ route('administracion.administrativa.estudiantes.create') }}"
                class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full focus:outline-none focus:shadow-outline text-sm">Crear
                Usuario</a>
        </div>
        {{-- mensaje de session --}}
        @if (session('menssage'))
