                        ...
                        <div class="p-8 space-y-8">
                            ...
                            <div class="bg-white rounded-2xl p-6 border-2 border-emerald-200">
                                ...
                                <div class="grid grid-cols-2 md:grid-cols-6 gap-4">
                                    ...
                                    <div class="space-y-2">
                                        <label class="block text-sm font-semibold text-slate-700">Insumo 2</label>
                                        <input type="number" step="0.01" min="0" max="10"
                                    ...
                                    <div class="space-y-2">
                                        <label class="block text-sm font-semibold text-slate-700">Insumo 3</label>
                                        <input type="number" step="0.01" min="0" max="10"
                                    ...
                                    <div class="space-y-2">
                                        <label class="block text-sm font-semibold text-slate-700">Insumo 4</label>
                                        <input type="number" step="0.01" min="0" max="10"
                                    ...
                                    <div class="space-y-2">
                                        <label class="block text-sm font-semibold text-slate-700">Insumo 5</label>
                                        <input type="number" step="0.01" min="0" max="10"
                                    ...
                                    <div class="space-y-2">
                                        <label class="block text-sm font-semibold text-slate-700">Promedio</label>
                                ...
                                <div class="bg-white rounded-xl p-4 border border-indigo-200 space-y-3">
                                    <div>
                                        <p class="text-indigo-900 font-bold text-lg mb-2">
                                            Nota Final = (Promedio Insumos × 30%) + (Examen Parcial × 30%) + (Examen
                                            Final × 40%)
                                        </p>
                                        <p class="text-indigo-700 text-sm">
                                            ...
                                            <span class="font-bold text-lg text-indigo-900">
                                                {{ number_format($promedio_insumos * 0.3 + ($examen_parcial ?: 0) * 0.3 + ($examen_final ?: 0) * 0.4, 2) }}
                                            </span>
                                        </p>
                                    </div>
