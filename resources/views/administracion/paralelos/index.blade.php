            ...
            <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <div>
                    ...
                    <p class="text-sm text-gray-500 dark:text-gray-400">
                        Gestión de paralelos, cupos y estado.
                    </p>
                </div>

                <a href="{{ route('administracion.administrativa.paralelos.create') }}"
                ...
                <div
                    ...
                    <div class="flex items-start justify-between gap-4">
                        ...
                        <div class="text-right">
                            ...
                            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                                {{ $paralelo->updated_at->diffForHumans() }}
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="mt-4 grid grid-cols-2 gap-3 text-sm">
                        <div class="rounded-lg bg-gray-50 dark:bg-gray-800/60 p-3">
                            <p class="text-xs text-gray-500 dark:text-gray-400">Cupo máximo</p>
                            <p class="font-semibold text-gray-800 dark:text-gray-100">
                                {{ $paralelo->cupo_maximo }}
                            </p>
                        </div>

                        <div class="rounded-lg bg-gray-50 dark:bg-gray-800/60 p-3">
                            <p class="text-xs text-gray-500 dark:text-gray-400">Cupo actual</p>
                            <p class="font-semibold text-gray-800 dark:text-gray-100">
                                {{ $paralelo->cupo_actual }}
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="mt-4 flex items-center justify-end gap-2">
                        <a href="{{ route('administracion.administrativa.paralelos.edit', $paralelo) }}"
                        ...
                        <form action="{{ route('administracion.administrativa.paralelos.destroy', $paralelo) }}"
                            method="POST">
                            @csrf
                            @method('DELETE')
                            <button type="submit"
                                onclick="return confirm('¿Seguro que deseas eliminar este paralelo?')"
                                class="inline-flex items-center gap-2 px-3 py-2 rounded-lg text-sm font-semibold
                ...
                <table class="min-w-full text-sm">
                    <thead class="bg-gray-50 dark:bg-gray-800/60">
                        <tr class="text-gray-700 dark:text-gray-200">
                            ...
                            <th class="px-4 py-3 text-center font-bold">Cupo Máx.</th>
                            <th class="px-4 py-3 text-center font-bold">Cupo Actual</th>
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/40 transition">
                                ...
                                <td class="px-4 py-3">
                                    <div class="flex items-center justify-center gap-3">
                                        ...
                                        <form
                                            action="{{ route('administracion.administrativa.paralelos.destroy', $paralelo) }}"
                                            method="POST">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit"
