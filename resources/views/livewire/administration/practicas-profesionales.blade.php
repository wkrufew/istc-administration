<div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                <h2 class="text-2xl font-bold text-gray-800">Prácticas Preprofesionales</h2>
                <p class="text-gray-500 text-sm mt-1">Gestión de prácticas de estudiantes con malla completa</p>
            </div>
