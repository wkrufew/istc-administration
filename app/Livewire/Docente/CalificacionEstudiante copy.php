...
class CalificacionEstudiante extends Component
{
    ...
    public $examen_final = '';
    public $nota_suspenso = ''; // Nueva propiedad
    public $estado_final = '';
    ...
    public function calcularNotaFinal()
    {
        ...
        if ($this->nota_final >= 4 && $this->nota_final < 7) {
            $this->suspenso = true; // Activar para mostrar el campo
            ...
            $this->suspenso = false;
            $this->nota_suspenso = ''; // Limpiar si no aplica
        }
    ...
    public function determinarEstadoFinal()
    {
        ...
        } elseif ($this->nota_final < 4) {
            $this->estado_final = 'Reprobado';
        } elseif ($this->nota_final < 7 && $this->nota_final >= 4) {
            // Si puede rendir suspenso
            if ($this->nota_suspenso !== null) {
                // Si ya se ingresó la nota de suspenso y alcanza 7
                if ($this->nota_final >= 7) {
                    $this->estado_final = 'Aprobado';
                } else {
                    $this->estado_final = 'Reprobado';
                ...
                // Pendiente de suspenso
                $this->estado_final = 'Pendiente Suspenso';
            }
        } else {
    ...
    /* public function updatedSuspenso()
    {
        $this->determinarEstadoFinal();
    } */
    ...
    public function guardarCalificacion()
    {
        ...
        try {
            ...
            if ($this->calificacion_actual) {
                ...
                Calificacion::create($datos_calificacion);
